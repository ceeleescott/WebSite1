...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel2" runat="server" style="z-index: 1; width: 655px; height: 68px; position: absolute; top: 232px; left: 111px">
        <div class="text-center">
            ...
            <asp:Login ID="Login1" runat="server" BackColor="#F7F6F3" BorderColor="#E6E2D8" BorderPadding-="4" BorderStyle="Solid" BorderWidth="1px" DestinationPageUrl="~/League Table.aspx" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" Height="325px" OnAuthenticate="Login1_Authenticate" Width="667px">
