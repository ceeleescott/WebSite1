...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="lblGallery" runat="server" style="z-index: 1; left: 375px; top: 102px; position: absolute; text-align: center" Text="Gallery" BorderStyle="None" BorderWidth="0px"></asp:Label>
        <asp:Label ID="lblBlackbird" runat="server" style="z-index: 1; left: 265px; top: 190px; position: absolute; height: 99px; width: 143px" Text="Length: 24-25 cm       Wing Span: 35-38 cm   Weight: 80-125 g   Present: All Year Round" Visible="False"></asp:Label>
