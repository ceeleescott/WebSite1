...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p style="height: 1807px" class="text-left">
        <strong>
        ...
        <asp:Image ID="imgPheasant" runat="server" ImageUrl="~/Media Content/Gallery Images/Pheasant.jpg" style="left: 45px; top: 1375px; bottom: 153px; width: 144px; height: 125px;" />
        <asp:Image ID="imgPigeon" runat="server" ImageUrl="~/Media Content/Gallery Images/Pigeon.jpg" style="left: 645px; top: 1550px; bottom: 292px; width: 144px; height: 125px;" />
        <asp:Image ID="imgRaven" runat="server" height="95px" ImageUrl="~/Media Content/Gallery Images/Raven.jpg" style="left: 235px; top: 1775px; bottom: 68px" width="119px" />
        <asp:Image ID="imgRobin" runat="server" height="95px" ImageUrl="~/Media Content/Gallery Images/Robin.jpg" style="left: 390px; top: 1770px; bottom: 73px" width="119px" />
        <asp:Image ID="imgSwallow" runat="server" height="95px" ImageUrl="~/Media Content/Gallery Images/Swallow.jpg" style="left: 675px; top: 1770px; bottom: 73px" width="119px" />
        <asp:Image ID="imgRook" runat="server" height="95px" ImageUrl="~/Media Content/Gallery Images/Rook.jpg" style="left: 535px; top: 1770px; bottom: 73px" width="119px" />
        <strong>
        ...
        <asp:Label ID="lblPheasant" runat="server" style="z-index: 1; position: absolute; top: 1370px; left: 220px; text-decoration: underline;" Text="Pheasant"></asp:Label>
        <asp:Label ID="lblPigeon" runat="server" style="z-index: 1; position: absolute; top: 1540px; left: 565px; text-decoration: underline;" Text="Pigeon"></asp:Label>
        </strong>
        <asp:Label ID="lblRaven" runat="server" style="z-index: 1; position: absolute; top: 1735px; left: 270px" Text="Raven"></asp:Label>
        <asp:Label ID="lblRobin" runat="server" style="z-index: 1; position: absolute; top: 1725px; left: 435px; width: 45px; height: 0px;" Text="Robin"></asp:Label>
        <asp:Label ID="lblRook" runat="server" style="z-index: 1; position: absolute; top: 1730px; left: 565px" Text="Rook"></asp:Label>
        <asp:Label ID="lblSwallow" runat="server" style="z-index: 1; position: absolute; top: 1730px; left: 710px" Text="Swallow"></asp:Label>
        ...
        <asp:Label ID="lblPigeonDescript" runat="server" style="z-index: 1; position: absolute; top: 1645px; left: 50px; width: 575px; height: 25px" Text="The Feral Pigeon is descended from the Rock Dove and can have similar plumage, though there are also many mixes of black, browns, white and piebald. The call is a continuous, bubbling moan. "></asp:Label>
    </p>
</asp:Content>
