...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p style="height: 1000px; width: 975px;">
		...
		<asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; position: absolute; top: 764px; left: 348px; width: 623px; height: 179px" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
