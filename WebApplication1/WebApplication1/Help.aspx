...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p style="height: 1055px; width: 1148px;">
		<br />
		...
		<asp:Button ID="Button1" runat="server" style="left: 192px; top: 967px; width: 156px; height: 48px;" Text="Submit Query" OnClick="Button1_Click" />
		<asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; position: absolute; top: 767px; left: 335px; width: 817px; height: 257px"></asp:TextBox>
	</p>
